...
<form id="create-new-test" action="${request.url}" method="POST"></form>
<div class="container">
<div class="row">
  ...
  <div class="flex-row">
    ...
    <div class="btn-group btn-group-sm text-nowrap choose-test-type">
      <div class="btn border" id="fast_test"
            title="Short time control, single-threaded"
      ...
      <div class="btn border" id="slow_test"
            title="Long time control, single-threaded"
      ...
      <div class="btn border" id="fast_smp_test"
            title="Short time control, multi-threaded"
      ...
      <div class="btn border" id="slow_smp_test"
            title="Long time control, multi-threaded"
  ...
  <div class="mb-3">
    ...
    <input type="url" name="tests-repo"
            id="tests-repo" class="form-control"
  ...
  <div class="mb-3 col-sm-6">
    ...
    <input type="text" name="new-options"
            id="new-options" class="form-control"
  ...
  <div class="mb-3 col-sm-6">
    ...
    <input type="text" name="base-options"
            id="base-options" class="form-control"
            value="${args.get('base_options', 'Hash=16 Use NNUE=true')}">
  </div>

  <div class="mb-3">
    <label for="run-info" class="form-label">Base Options</label>
      <textarea name="run-info" placeholder="Defaults to commit message"
                id="run-info"class="form-control"
  ...
  <div class="flex-row">
    ...
    <div class="btn-group btn-group-sm">
      <div class="btn btn-info border" data-stop-rule="sprt" title="Sequential probability ratio test" style="width: 94px">SPRT</div>
      <div class="btn border" data-stop-rule="numgames" title="Fixed number of games" style="width: 100px">Num games</div>
      <div class="btn border" data-stop-rule="spsa" title="Simultaneous perturbation stochastic approximation" style="width: 94px">SPSA</div>
    </div>
