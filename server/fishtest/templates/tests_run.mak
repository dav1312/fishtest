        ...
        <div class="row">
          <div class="col-12 col-md-6 mb-2">
            <div class="row gx-1">
              <div class="mb-2">
                ...
                <div class="list-group list-group-checkable flex-row row row-cols-2 row-cols-xl-4 g-1">
                  <div class="col">
                    <input class="list-group-item-check pe-none" type="radio" name="test-type" id="fast_test"
                      ...
                      checked>
                    <label class="list-group-item rounded-3 px-3 py-md-3" for="fast_test" title="Short time control | Single-threaded">
                      <h5 class="mb-0">STC</h5>
                    </label>
                  </div>
                  ...
                  <div class="col">
                    ...
                    <label class="list-group-item rounded-3 px-3 py-md-3" for="slow_test" title="Long time control | Single-threaded">
                      <h5 class="mb-0">LTC</h5>
                    </label>
                  </div>
                  ...
                  <div class="col">
                    ...
                    <label class="list-group-item rounded-3 px-3 py-md-3" for="fast_smp_test" title="Short time control | Multi-threaded">
                      <h5 class="mb-0">STC SMP</h5>
                    </label>
                  </div>
                  ...
                  <div class="col">
                    ...
                    <label class="list-group-item rounded-3 px-3 py-md-3" for="slow_smp_test" title="Long time control | Multi-threaded">
                      <h5 class="mb-0">LTC SMP</h5>
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-2 col-6">
                ...
                <input type="number" name="test-signature" id="test-signature" min="0" class="form-control" onwheel="this.blur()"
              ...
              <div class="mb-2 col-6">
                ...
                <input type="number" name="base-signature" id="base-signature" min="0" class="form-control" onwheel="this.blur()"
              ...
              <div>
                ...
                <textarea name="run-info" placeholder="Defaults to commit message" id="run-info" class="form-control"
          ...
          <div class="col-12 col-md-6 mb-2">
            <div class="mb-2">
              ...
              <div class="list-group list-group-checkable flex-row row row-cols-3 g-1">
                <div class="col">
                  <input class="list-group-item-check pe-none" type="radio" name="stop-rule" id="stop-rule-sprt"
                    value="stop-rule-sprt" checked>
                  <label class="list-group-item rounded-3 px-3 py-md-3" for="stop-rule-sprt" title="Sequential probability ratio test">
                    <h5 class="mb-0">SPRT</h5>
                  </label>
                </div>
                ...
                <div class="col">
                  ...
                  <label class="list-group-item rounded-3 px-3 py-md-3" for="stop-rule-games" title="Fixed amount of games">
                ...
                <div class="col">
                  ...
                  <label class="list-group-item rounded-3 px-3 py-md-3" for="stop-rule-spsa" title="Simultaneous perturbation stochastic approximation">
                    <h5 class="mb-0">SPSA</h5>
                  </label>
                </div>
              </div>
            </div>
  ...
  document.querySelectorAll("[name=stop-rule]").forEach((btn) =>
    btn.addEventListener("click", function () {
      ...
      if (stopRule) {
        ...
        document.getElementById("stop_rule_field").value = stopRule;
